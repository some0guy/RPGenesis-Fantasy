...
class ComponentsField(ttk.Frame):
    def __init__(self, master, labels):
        ...
        ent = ttk.Entry(top, textvariable=self.filter_var, width=24); ent.pack(side="left", padx=(6,6))
        self.cat_var = tk.StringVar(value="materials")
        self.cat_combo = ttk.Combobox(top, values=("materials","armour","weapons","clothing","accessories","trinkets","consumables","misc"), textvariable=self.cat_var, state="readonly", width=18)
        ...
        self._refill()
        # Clear selections only when clicking *outside* this picker
